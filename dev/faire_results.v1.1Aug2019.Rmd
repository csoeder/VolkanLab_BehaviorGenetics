...
(grand_mean_peak_width) `$ base pairs. Peaks also had intensity values measuring signal enhancement over the genomic background; these averaged at $`r human_readable_croncher
...
In addition to testing the association of the full gene annotation with peaks, the association of peaks with a specified subset of the genes can also be tested. 
...
TODO: randomization - grab n randos k times for comparison; shuffle gnees & randos with bedtools; compare overlaps, upstream, downstream
...
### GO:0003700 DNA trans factor act

MT??

### GO: synapse signalling

1 gene

### GO: synapse org

MT http://flybase.org/cgi-bin/cvreport.pl?id=GO%3A0050808

...
keys = ['total_read_count','total_mapped_count', 'properly_paired_count','avg_depth', 'std_depth', 'spanned_breadth', 'split_breadth','uniquely_mapped','nonunique_locii','nonunique_reads', "avg_mapping_multiplicity", 'duplicate_reads']
